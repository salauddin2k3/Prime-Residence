                    ...
                    <SwiperSlide className='bg-[url("https://i.ibb.co/dKffZWV/01.png")] bg-no-repeat bg-cover py-40'>
                        <div className='flex justify-center mx-2'>
                            <div className='p-4  lg:p-24 border border-[#f7614d] w-fit rounded-2xl bg-gray-600 bg-opacity-30 text-center'>
                                <h4 className='text-sm lg:text-xl font-medium text-white'>Welcome to <span className='font-bold'>Prime Residence</span></h4>
                                <h2 className='mt-4 text-3xl lg:text-6xl font-extrabold text-[#f7614d]'>Manage Your Property</h2>
                                <p className='mt-3 text-sm lg:text-base font-semibold text-white'>Your will have everything nearby Single-family homes, townhouses, apartments, <br /> senior living communities and the student housing, etc</p>
